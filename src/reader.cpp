...
reader::reader()
{
	...
	m_map_cls_name_cpp["int8"] = "int8_t";
	m_map_cls_name_cpp["int16"] = "int16_t";
	m_map_cls_name_cpp["int32"] = "int32_t";
	m_map_cls_name_cpp["int64"] = "int64_t";
	m_map_cls_name_cpp["uint"] = "uint32_t";
	m_map_cls_name_cpp["uint8"] = "uint8_t";
	m_map_cls_name_cpp["uint16"] = "uint16_t";
	m_map_cls_name_cpp["uint32"] = "uint32_t";
	m_map_cls_name_cpp["uint64"] = "uint64_t";
	m_map_cls_name_cpp["long"] = "long";
	m_map_cls_name_cpp["ulong"] = "ulong";
	m_map_cls_name_cpp["float"] = "float";
	m_map_cls_name_cpp["float32"] = "float";
	m_map_cls_name_cpp["float64"] = "float";
	...
	m_map_cls_name_py3["int8"] = "0";
	m_map_cls_name_cpp["int16"] = "0";
	m_map_cls_name_cpp["int32"] = "0";
	m_map_cls_name_cpp["int64"] = "0";
	m_map_cls_name_py3["uint"] = "0";
	m_map_cls_name_cpp["uint8"] = "0";
	m_map_cls_name_cpp["uint16"] = "0";
	m_map_cls_name_cpp["uint32"] = "0";
	m_map_cls_name_cpp["uint64"] = "0";
	m_map_cls_name_py3["long"] = "0";
	m_map_cls_name_py3["ulong"] = "0";
	m_map_cls_name_py3["float"] = "0.0";
	m_map_cls_name_cpp["float32"] = "0.0";
	m_map_cls_name_cpp["float64"] = "0.0";
	m_map_cls_name_cpp["double"] = "0.0";
