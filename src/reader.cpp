...
reader::reader()
{
	...
	m_map_cls_name_py3["int16"] = "0";
	m_map_cls_name_py3["int32"] = "0";
	m_map_cls_name_py3["int64"] = "0";
	m_map_cls_name_py3["uint"] = "0";
	m_map_cls_name_py3["uint8"] = "0";
	m_map_cls_name_py3["uint16"] = "0";
	m_map_cls_name_py3["uint32"] = "0";
	m_map_cls_name_py3["uint64"] = "0";
	m_map_cls_name_py3["long"] = "0";
	m_map_cls_name_py3["ulong"] = "0";
	m_map_cls_name_py3["float"] = "0.0";
	m_map_cls_name_py3["float32"] = "0.0";
	m_map_cls_name_py3["float64"] = "0.0";
	m_map_cls_name_py3["double"] = "0.0";
